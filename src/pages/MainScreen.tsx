      ...
      <div className="relative z-10 min-h-screen flex flex-col safe-area-pt safe-area-pb">
          ...
          <div className="flex items-center gap-3">
            {isLoggedIn ? (
              ...
              <Button
                ...
                className="h-11 px-6 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 font-semibold shadow-lg"
              >
                Sign In
              </Button>
            )}
        ...
        <main className="px-5 pb-8">
          ...
          <div className="text-center mb-10">
            <h1 className="text-4xl font-display text-white mb-2 drop-shadow-lg">AI My Dubai</h1>
            <p className="text-xl text-white/90 font-medium drop-shadow-md">Concierge. It. Done.</p>
          ...
          {!isLoggedIn && (
            <Button 
              onClick={() => navigate('/login')}
              variant="ghost"
              className="w-full h-14 mt-3 text-white hover:bg-white/10 rounded-2xl text-base border border-white/20"
            >
